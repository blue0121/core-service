...
import io.jutil.coreservice.core.dao.AuditLogMapper;
...
public class AuditLogRepository {
	...
	public int add(AuditLogFacade.Business business, long tenantId, long businessId, long operatorId,
	               Operation operation, Object content) {
		var entity = new AuditLog();
		entity.setId(LongIdGenerator.nextId());
		entity.setBusiness(business.getLabel());
	...
	public int addOperation(AuditLogFacade.Business business, long tenantId, long businessId,
	                        long operatorId, Object content) {
		return this.add(business, tenantId, businessId, operatorId, Operation.ADD, content);
	}

	public int updateOperation(AuditLogFacade.Business business, long tenantId, long businessId,
	                           long operatorId, Object content) {
		return this.add(business, tenantId, businessId, operatorId, Operation.UPDATE, content);
	}

	public int deleteOperation(AuditLogFacade.Business business, long tenantId, long businessId,
	                           long operatorId) {
		return this.add(business, tenantId, businessId, operatorId, Operation.DELETE,
				this.getIdContent(businessId));
	}

	public int deleteListOperation(AuditLogFacade.Business business, long tenantId, Collection<Long> businessIdList,
	                               long operatorId) {
		int count = 0;
